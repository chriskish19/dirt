...
namespace core {
	...
	*/
	...
	/*
		displays information for the arg entry e to the user 
	*/
	...
	*/
	...
	/*
		returns string information on file_entry object entry formats it for output to the terminal
	*/
	std::string output_entry_data(const file_entry& entry,const std::string& name);
	...
	*/
	...
	/*
		sends a file system error code to terminal or whatever output pipe is setup 
	*/
