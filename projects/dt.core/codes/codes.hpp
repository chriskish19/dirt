...
namespace core {
	...
	*/
    enum class codes {
        ...
        // file related
        file_copy_fail,                             // attempted to copy a file but failed to copy it
        file_delete_fail,                           // attempted to delete a file but failed to actually delete it
        directory_delete_fail,                      // attempted to delete a directory but failed to actually delete it
	...
	*/
    ...
    inline const code_pkg file_copy_fail_pkg(codes::file_copy_fail, "core::codes::file_copy_fail | message: attempted to copy a file but the file was not actually copied to the destination");
